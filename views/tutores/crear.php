    ...
    <div class="contenedor">
        ...
        <div class="tarjeta">
            ...
            <form method="POST" action="index.php?accion=tutor_crear">
                <label for="id_usuario">Usuario (con rol Tutor):</label>
                ...
                <input type="text" id="especialidad" name="especialidad" placeholder="Ej: Matemáticas, Programación...">
                <label for="biografia">Biografía / Perfil:</label>
                <textarea id="biografia" name="biografia" rows="4" placeholder="Breve descripción académica..."></textarea>
