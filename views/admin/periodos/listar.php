...
$descripcion = 'Define el rango de fechas dentro del cual los estudiantes podrán agendar tutorías.';
$icono = 'bi-calendar-range';
$accion = '<button type="button" class="btn btn-primary d-flex align-items-center gap-2 shadow-sm px-3 py-2 rounded-3" data-bs-toggle="modal" data-bs-target="#modalPeriodo" onclick="prepararCrear()"><i class="bi bi-plus-circle-fill"></i><span class="fw-semibold">Nuevo Periodo</span></button>';
