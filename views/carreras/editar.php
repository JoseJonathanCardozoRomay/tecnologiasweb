...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Times New Roman', Georgia, serif; }
        ...
        input { width: 100%; padding: 13px 15px; border: 1px solid #99b3cc; border-radius: 6px; font-size: 15px; background: #fafcff; }
...
<body>
    <div class="contenedor">
        <div class="encabezado">
            <h1>✏️ Editar Carrera</h1>
            <a href="index.php?accion=carreras_listar" class="volver-btn">← Volver al Listado</a>
        </div>
        <div class="tarjeta">
            ...
            <form method="POST" action="index.php?accion=carrera_editar&id=<?= $carrera['id_carrera'] ?>">
                ...
                <input type="text" id="nombre_carrera" name="nombre_carrera" value="<?= htmlspecialchars($carrera['nombre_carrera']) ?>" required>
