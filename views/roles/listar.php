...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Times New Roman', Georgia, serif; }
        ...
        .mensaje-error { background: #ffe6e6; border-left: 4px solid #b30000; color: #800000; }
...
<body>
    <div class="contenedor">
        ...
        <div class="tarjeta">
            <a href="index.php?accion=rol_crear" class="btn btn-primario nuevo">+ Nuevo Rol</a>

            <?php if ($mensaje === 'creado'): ?>
                <div class="mensaje mensaje-exito">✅ Rol creado correctamente.</div>
            <?php endif; ?>
            <?php if ($mensaje === 'actualizado'): ?>
                <div class="mensaje mensaje-exito">✅ Rol actualizado correctamente.</div>
            <?php endif; ?>
            <?php if ($mensaje === 'eliminado'): ?>
                <div class="mensaje mensaje-exito">✅ Rol eliminado correctamente.</div>
            <?php endif; ?>
            <?php if (isset($error)): ?>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?accion=rol_editar&id=<?= $rol['id_rol'] ?>" class="btn btn-aviso">Editar</a>
