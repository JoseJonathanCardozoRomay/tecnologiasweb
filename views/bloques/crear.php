...
<head>
    <meta charset="UTF-8">
    <title>Nuevo Bloque Horario</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Times New Roman', Georgia, serif; }
        ...
        input, textarea { width: 100%; padding: 12px 15px; border: 1px solid #99b3cc; border-radius: 6px; font-size: 15px; background: #fafcff; }
        input:focus, textarea:focus { outline: none; border-color: #cc9900; box-shadow: 0 0 0 3px rgba(204,153,0,0.2); }
...
<body>
    <div class="contenedor">
        <div class="encabezado">
            <h1>🕐 Nuevo Bloque Horario</h1>
            <a href="index.php?accion=bloques_listar" class="volver-btn">← Volver</a>
        </div>
        <div class="tarjeta">
            ...
            <form method="POST" action="index.php?accion=bloque_crear">
                <label for="nombre_bloque">Nombre del Bloque:</label>
                <input type="text" id="nombre_bloque" name="nombre_bloque" placeholder="Ej: Mañana, Tarde, Noche" required>
                <label for="hora_inicio">Hora de Inicio:</label>
                <input type="time" id="hora_inicio" name="hora_inicio" required>
                <label for="hora_fin">Hora de Finalización:</label>
                <input type="time" id="hora_fin" name="hora_fin" required>
                <label for="descripcion">Descripción:</label>
                <textarea id="descripcion" name="descripcion" rows="3" placeholder="Breve descripción del bloque..."></textarea>
