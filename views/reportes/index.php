...
<div class="row g-3 mb-4">
  ...
  <div class="col-6 col-lg-3"><div class="card card-custom p-3 h-100"><small class="text-muted text-uppercase fw-bold">Satisfacción</small><div class="fs-2 fw-bold text-warning mt-2"><?= $satisfaccion['promedio_satisfaccion'] ? number_format($satisfaccion['promedio_satisfaccion'], 2) : '—' ?><small class="fs-6 text-muted"> / 5</small></div></div></div>
</div>
...
<style>
  .report-heading { display: flex; justify-content: space-between; align-items: center; border-left: 4px solid #f5a623; background: #fff; padding: .8rem 1rem; }
  ...
  @media print {
    ...
    .report-heading { border: 1px solid #e2e8f0; border-left: 4px solid #f5a623; }
  }
</style>
