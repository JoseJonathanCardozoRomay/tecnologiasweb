...
<div class="d-flex flex-column flex-lg-row justify-content-between gap-3 mb-4">
    ...
    <div class="d-flex flex-wrap gap-2"><button class="btn btn-sm btn-outline-secondary page-header-compact-action" onclick="window.print()"><i class="bi bi-printer me-1"></i>Imprimir</button><a class="btn btn-sm btn-outline-secondary page-header-compact-action" href="auditoria_descargar.php?desde=<?=urlencode($desde)?>&hasta=<?=urlencode($hasta)?>"><i class="bi bi-file-earmark-spreadsheet me-1"></i>Descargar Excel</a></div>
</div>
...
<div class="card card-custom p-3 mb-4 audit-filters">
    ...
    <div class="small text-muted mt-3"><i class="bi bi-info-circle me-1"></i>Si dejas ambas fechas vacías, el archivo Excel incluye todos los registros de auditoría.</div>
</div>

<div class="card card-custom overflow-hidden">
    <div class="p-3 border-bottom"><strong><?=count($registros)?></strong> registro(s) mostrado(s). La vista web está limitada a 1000 filas; la descarga Excel no aplica ese límite.</div>
