        ...
        <div class="tarjeta">
            ...
            <form method="POST" action="index.php?accion=tutoria_crear">
                ...
                <select name="id_estudiante" id="id_estudiante" required>
                    ...
                    <option value="<?= $e['id_estudiante'] ?>"><?= htmlspecialchars($e['nombre_completo']) ?> — <?= htmlspecialchars($e['carrera']) ?></option>
                    <?php endwhile; ?>
                </select>
                ...
                <textarea id="tema" name="tema" rows="3" placeholder="Temas a tratar en la tutoría..."></textarea>
                ...
                <button type="submit">✅ Programar Tutoría</button>
            </form>
        </div>
    </div>
</body>
