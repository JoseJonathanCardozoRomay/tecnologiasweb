...
<body>
    <div class="contenedor">
        <div class="encabezado">
            <h1>✏️ Editar Tutor</h1>
            <a href="index.php?accion=tutores_listar" class="volver-btn">← Volver al Listado</a>
        </div>
        <div class="tarjeta">
            ...
            <form method="POST" action="index.php?accion=tutor_editar&id=<?= $tutor['id_tutor'] ?>">
                ...
                <input type="text" id="especialidad" name="especialidad" value="<?= htmlspecialchars($tutor['especialidad'] ?? '') ?>">
                <label for="biografia">Biografía / Perfil:</label>
                <textarea id="biografia" name="biografia" rows="4"><?= htmlspecialchars($tutor['biografia'] ?? '') ?></textarea>
