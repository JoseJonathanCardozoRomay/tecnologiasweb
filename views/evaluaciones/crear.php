    ...
    <div class="contenedor">
        ...
        <div class="tarjeta">
            ...
            <form method="POST" action="index.php?accion=evaluacion_crear">
                <label for="id_tutoria">Tutoría Realizada:</label>
                <select name="id_tutoria" id="id_tutoria" required>
                    ...
                    <option value="<?= $t['id_tutoria'] ?>">
                        Tutoría #<?= $t['id_tutoria'] ?> — <?= htmlspecialchars($t['estudiante']) ?> — <?= htmlspecialchars($t['nombre_materia']) ?>
                    </option>
                    <?php endwhile; ?>
                </select>
                ...
                <textarea id="comentario" name="comentario" rows="4" placeholder="Escribe tu opinión sobre la tutoría..."></textarea>
