...
INSERT INTO `modalidades_graduacion` VALUES (1,'Proyecto','Desarrollo de una propuesta o solución aplicada.',1,'2026-09-23 22:12:57'),(2,'Tesis','Trabajo de investigación académica.',1,'2026-09-23 22:12:57'),(3,'Trabajo Dirigido','Trabajo desarrollado dentro de una institución.',1,'2026-09-23 22:12:57'),(4,'Tesis de grado fsfsf','sadad',1,'2026-09-24 19:47:41');
...
INSERT INTO `periodos_inscripcion` VALUES (1,'2026-6','Segundo semestre 2026','2026-09-24','2026-10-08','abierto','2026-09-24 21:01:45');
...
INSERT INTO `registro_accesos` VALUES (1,1,'2026-09-18 22:12:15','192.168.143.1','exitoso'),(2,1,'2026-09-18 23:55:58','192.168.178.1','exitoso'),(3,NULL,'2026-09-20 17:38:45','192.168.143.1','fallido'),(4,NULL,'2026-09-20 17:45:40','192.168.143.1','fallido'),(5,1,'2026-09-20 17:45:50','192.168.143.1','exitoso'),(6,1,'2026-09-20 19:17:27','192.168.143.1','exitoso'),(7,1,'2026-09-20 19:17:43','192.168.143.1','exitoso'),(8,7,'2026-09-20 20:23:57','192.168.143.1','exitoso'),(9,7,'2026-09-20 20:24:28','192.168.143.1','fallido'),(10,7,'2026-09-20 20:24:33','192.168.143.1','exitoso'),(11,8,'2026-09-20 20:34:51','192.168.143.1','fallido'),(12,1,'2026-09-20 20:35:08','192.168.143.1','exitoso'),(13,7,'2026-09-20 20:40:49','192.168.143.1','exitoso'),(14,1,'2026-09-20 20:41:32','192.168.143.1','exitoso'),(15,7,'2026-09-20 20:43:26','192.168.143.1','fallido'),(16,1,'2026-09-20 20:46:53','192.168.143.1','exitoso'),(17,7,'2026-09-20 20:47:46','192.168.143.1','exitoso'),(18,7,'2026-09-20 20:49:24','192.168.143.1','fallido'),(19,1,'2026-09-23 20:54:09','192.168.143.1','exitoso'),(20,2,'2026-09-23 21:25:19','192.168.143.1','fallido'),(21,1,'2026-09-23 21:25:27','192.168.143.1','exitoso'),(22,8,'2026-09-23 21:26:04','192.168.143.1','exitoso'),(23,1,'2026-09-23 21:26:49','192.168.143.1','exitoso'),(24,8,'2026-09-23 21:27:22','192.168.143.1','exitoso'),(25,1,'2026-09-24 19:30:56','192.168.143.1','exitoso');
...
INSERT INTO `reglas_modalidad_etapa` VALUES (1,1,'grado_1',1,0),(2,2,'grado_1',1,0),(3,3,'grado_1',1,0),(4,1,'grado_2',0,4),(5,2,'grado_2',0,4),(6,3,'grado_2',0,4),(7,4,'grado_1',2,20),(8,4,'grado_2',7,20);
...
CREATE TABLE `tutorias` (
  ...
  `id_tutor_sugerido` int DEFAULT NULL,
  `id_materia` int NOT NULL,
  `id_modalidad` int DEFAULT NULL,
  `id_periodo` int DEFAULT NULL,
  `etapa` enum('grado_1','grado_2') DEFAULT NULL,
  `titulo_trabajo` varchar(200) DEFAULT NULL,
  `descripcion_tematica` text,
  ...
  `estado` enum('pendiente','confirmada','asignada','en_proceso','en_reasignacion','detenido','realizada','finalizada','cancelada') NOT NULL DEFAULT 'pendiente',
  `observaciones` text,
  ...
  KEY `fk_tutorias_creador` (`creado_por`),
  KEY `idx_tutorias_modalidad` (`id_modalidad`),
  KEY `idx_tutorias_periodo` (`id_periodo`),
  KEY `idx_tutorias_tutor_sugerido` (`id_tutor_sugerido`),
  KEY `idx_tutorias_etapa` (`etapa`),
  CONSTRAINT `fk_tutorias_creador` FOREIGN KEY (`creado_por`) REFERENCES `usuarios` (`id_usuario`) ON DELETE SET NULL ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_tutorias_modalidad` FOREIGN KEY (`id_modalidad`) REFERENCES `modalidades_graduacion` (`id_modalidad`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_tutorias_periodo` FOREIGN KEY (`id_periodo`) REFERENCES `periodos_inscripcion` (`id_periodo`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_tutorias_tutor` FOREIGN KEY (`id_tutor`) REFERENCES `tutores` (`id_tutor`) ON UPDATE CASCADE,
  CONSTRAINT `fk_tutorias_tutor_sugerido` FOREIGN KEY (`id_tutor_sugerido`) REFERENCES `tutores` (`id_tutor`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-09-24 22:24:06
