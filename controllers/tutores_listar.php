...
$ordenesPermitidos = ['nombre', 'especialidad', 'materias', 'horarios'];
...
$totalRegistros = $tutorModel->contar($q);
$pag = paginacionCalcular($totalRegistros, $parametrosPagina);
$tutores = $tutorModel->obtenerPaginadas($q, $orden, $dir, $pag['por_pagina'], $pag['offset']);
