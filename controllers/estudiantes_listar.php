...
$ordenesPermitidos = ['nombre', 'registro', 'carrera', 'semestre', 'tutorias'];
...
$totalRegistros = $estudianteModel->contar($q);
$pag = paginacionCalcular($totalRegistros, $parametrosPagina);
$estudiantes = $estudianteModel->obtenerPaginadas($q, $orden, $dir, $pag['por_pagina'], $pag['offset']);
